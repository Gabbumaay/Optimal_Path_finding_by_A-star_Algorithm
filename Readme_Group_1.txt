...
2) while executing the code, Enter the name of the text file.

-> file contains following as inputs { no.of.cities, co-ordinates of the respective cities, distances available for the cities. } 
